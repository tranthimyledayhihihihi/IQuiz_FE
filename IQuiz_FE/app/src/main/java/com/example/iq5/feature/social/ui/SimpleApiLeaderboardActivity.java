...
/**
 * Simple Leaderboard Activity sử dụng API thật từ backend
 */
public class SimpleApiLeaderboardActivity extends AppCompatActivity {

    private static final String TAG = "SimpleApiLeaderboardActivity";
        ...
        socialRepository.getLeaderboard(type, 1, pageSize, 
            ...
            public void onSuccess(SocialApiService.LeaderboardResponse leaderboard) {
                runOnUiThread(() -> {
                    ...
                    Toast.makeText(SimpleApiLeaderboardActivity.this, message, Toast.LENGTH_LONG).show();
                    ...
                    if (leaderboard.getDanhSach() != null && !leaderboard.getDanhSach().isEmpty()) {
                        ...
                        Toast.makeText(SimpleApiLeaderboardActivity.this, 
